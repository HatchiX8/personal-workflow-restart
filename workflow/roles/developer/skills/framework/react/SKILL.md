---
name: react
description: Developer 的 React Framework 規則。當 project.config.json 的作用中 stack 宣告 frameworks 包含 react，或 repository evidence 明確顯示本次工作使用 React 時使用。
---

# Developer React Framework Skill

---
name: vue
description: Developer 的 Vue Framework 規則。當 project.config.json 的作用中 stack 宣告 frameworks 包含 vue，或 repository evidence 明確顯示本次工作使用 Vue 時使用。
---

# Developer Vue Framework Skill

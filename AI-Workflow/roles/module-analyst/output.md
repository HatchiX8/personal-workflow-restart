...
本文件同時遵守 `policies/evidence-confidence.md`、`policies/secret-handling.md` 與 `policies/report-file-policy.md`。
...
若既有 module context 已存在，覆寫與更新規則以 `AI-Workflow/roles/module-analyst/report.md` 為準。
